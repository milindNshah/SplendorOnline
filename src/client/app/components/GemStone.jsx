...
const Amount = styled.span`
  ...
  font-size: ${ props => `${props.width}rem` };
  color: ${ props => props.color ?? props.theme.color.white};
  padding-right: ${ props => `${props.width/3}rem` };
`;
...
const Chocolate = (props) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" height={`${height}rem`} width={`${width}rem`}>
